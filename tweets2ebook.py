...
from configuration import (
    ...
    item_styles, style_key, color_palette, latex_preamble_start,
...
def make_markdown_file():
    ...
    if Path("selected_tweets.csv").exists():
        ...
        if not Path(tweets_csv_file).exists():
            prepare_files(min_favorite_count_=0, min_date_='2015-01-01', max_date_='2023-01-01')
    ...
    latex_preamble = f"{latex_preamble_start}{color_palette}{item_styles.get(style_key, '')}{latex_preamble_end}"
